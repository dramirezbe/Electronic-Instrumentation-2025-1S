...
#include "io_utils.h"    // Asume que este archivo proporciona isr_io_config
...
{
    // Solo se incrementa el contador. Este código se ejecuta en la ISR con la máxima rapidez.
    interrupt_count++;
}
